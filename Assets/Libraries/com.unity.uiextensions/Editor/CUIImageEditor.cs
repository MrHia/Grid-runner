    ...
    public class CUIImageEditor : CUIGraphicEditor
    {
        ...
        protected override void OnSceneGUI()
        {
            ...
            if (script.UIImage.type == Image.Type.Sliced || script.UIImage.type == Image.Type.Tiled)
            {
                ...
                EditorGUI.BeginChangeCheck();
                var fmh_71_107_638980672300862598 = script.transform.rotation; Vector3 newCornerPos = Handles.FreeMoveHandle(script.transform.TransformPoint(cornerPos), HandleUtility.GetHandleSize(script.transform.TransformPoint(cornerPos)) / 7, Vector3.one, Handles.SphereHandleCap);
