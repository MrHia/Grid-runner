...
public class Enemy : EntityManager
{
    ...
    [SerializeField]
    private MeshDestroy meshDestroyHead;
    ...
    private void DestroyMesh(EnemyDeadType deadtype, Vector3 player_position)
    {
        switch (deadtype)
        {
            case EnemyDeadType.JumpAttack:
                ...
                meshDestroyHead.CutCascades = 0;
                meshDestroyHead.DestroyMesh(player_position);
                break;
            ...
            case EnemyDeadType.Strike:
                ...
                meshDestroy.DestroyMesh(player_position);
                meshDestroyHead.CutCascades  = 0;
                meshDestroyHead.ExplodeForce = 400;
                meshDestroyHead.DestroyMesh(player_position);
                break;
        }
    }
    private void PrepareToDie()
    {
        ...
        skinnedMeshRendererHead.enabled = false;
